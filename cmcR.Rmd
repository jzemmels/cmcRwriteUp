...
Both the CMC and High CMC methods are long, multi-step processes that are easier to run and debug when written as a modular pipeline of successive independent steps.
