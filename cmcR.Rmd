...
```{r echo=FALSE,message=FALSE,warning=FALSE,fig.width='\\textwidth'}
...
ggplot(data.frame(a = 1)) +
  ...
  annotation_custom(pltLegend,xmin = 2.7,xmax = 7,ymin = 2,ymax = 3) +
  ...
  annotation_custom(pltLegend,xmin = 22,xmax = 30,ymin = 2,ymax = 3) +
