...
Additionally, comparisons are performed in both “directions” so that each breech face scan takes on the role of the scan that is partitioned into a grid of cells.
