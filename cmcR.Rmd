...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{images/originalMethod_sideBySide.png}
...
knmComparison_ccfData %>%
  ...
  coord_fixed(expand = FALSE,ratio = .05) +
  scale_y_continuous(limits = c(0,4)) +
  ylab("# Cell Pairs") +
  theme(legend.position = c(1, 1), 
        legend.justification = c(1, 1), 
