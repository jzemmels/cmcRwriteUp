...
\jz{Starting to get into CMC-specific criticism here XXX I've attempted to add a more "aspirational" tone to this paragraph and address some of R1's comments, but it might feel a bit too much like a discussion/conclusion paragraph. I'm not sure how to phrase the criticism so that it doesn't sound like we're criticizing NIST overall and instead focusing on a set of papers from a small group of researchers.}
...
<!-- \jz{The content of this paragraph hasn't changed from the last re-submission. I'm not quite sure if/how an aspirational tone should be added.} -->
\jz{XXX The paragraph below is the first time we assert that the CMC methods are not reproducible. We won't re-iterate this point until the discussion/conclusion.}
