...
The CMCs under the original method of \citet{song_proposed_2013} are calculated in each direction and their minimum is used as an "original CMC number." \hh{Is that what actually happens? The minimum was not mentioned earlier. }
