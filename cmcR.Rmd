...
A truly matching pair of cartridge cases has similar translation and rotation values for each cell, while a nonmatching pair of cartridge cases exhibits a variety of different translation and rotation values without showing a particular pattern.
...
\hh{XXX note for the conclusion: how are these thresholds determined? Rather than using pre-set cutoffs, a joint density of the parameters could be determined and used in the assessment of similarity. XXX}
...
\begin{table}[ht]
    ...
    \begin{tabular}{|lrrr|}
      \hline
        ...
        \cellcolor{lightgray}{6} & \cellcolor{lightgray}{.6} \\
        ...
        \cellcolor{lightgray}{6} & \cellcolor{lightgray}{.5}\\
        \hline
    \end{tabular}
