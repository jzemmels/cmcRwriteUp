...
\citet{song_proposed_2013} refers to these as "valid correlation regions" that are used to determine whether two cartridge cases match. \hh{XXX how are these valid correlation regions defined? If they are not defined in detail, we should remark on that.}
