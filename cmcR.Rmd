...
horizontalTranslation_label <- ggplot() +
  annotate("text",x = 500,y = 300,size = 3,label = "  Horizontal \n Translation") +
  theme_void()

verticalTranslation_label <- ggplot() +
  annotate("text",x = 500,y = 300,size = 3,label = "  Vertical \n Translation") +
  theme_void()

rotation_label <- ggplot() +
  annotate("text",x = 500,y = 300,size = 3,label = "Rotation") +
  theme_void()

ccf_label <- ggplot() +
  annotate("text",x = 500,y = 300,size = 3,label = expression(paste("CCF"[max]))) +
  theme_void()
