...
\jz{\autoref{fig:cmc_varRatioComparison} shows variance ratio values based on results presented in various CMC papers using data from \citet{fadul_empirical_2011} and \citet{weller_2012}. 
Note that the breech face impression region were identified manually for the \citet{weller_2012} dataset using the FiX3P software (accessible here:} <https://github.com/talenfisher/fix3p>\jz{). 
