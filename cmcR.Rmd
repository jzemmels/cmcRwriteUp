...
Although a grid of $8 \times 8$ cells was used, there were 27 cell/region pairs that contained a sufficient proportion of non-missing values (15% in this example). 
...
kmComparisonFeatures %>%
  ...
  kableExtra::kable_styling(latex_options = "striped", 
                            position = "center", stripe_index=c(2,4,6),
                            stripe_color="lightgray")
```

## Decision Rule

\svp{Using the thetas, translation vectors, and CCFs produced by the correlation cell procedure, \citet{song_proposed_2013}, \citet{tong_improved_2015}, \citet{chen_convergence_2017} describe various methods for aggregating this information into a consensus decision about the similarity of the two cartridge cases.} 
