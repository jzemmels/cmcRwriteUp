...
\hh{XXX for each cell-region pair only the values $(x_i, y_i$ \theta_i)$ are considered, where the cross-correlation reaches its maximum.}
...
\hh{The CMC count under the High CMC method is then defined as the maximum of the described method and the CMC count of the original method. This way, the High CMC method  returns for any comparison of breech face scans a CMC count equal to or higher to the Original method.}
