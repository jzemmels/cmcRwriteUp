...
TODO:
 - Move this reproducibility discussion to pre-introduction
 - Focus on how the cmcR package illustrates a particular use-case
 - Set up Travis to knit a vignette version of the paper and push output to github
 - Make it more "research-y" by providing more "meta-level" information such as the exploration process we had to go through to arrive to conclusions we did
