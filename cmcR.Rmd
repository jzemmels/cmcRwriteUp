...
There is already precedence for open-sourcing NIST-developed code as evidenced by the many public Github repositories accessible at <https://github.com/usnistgov>.}
...
\jz{Start CMC-specific criticism}
...
\jz{Start CMC-specific criticism here}
...
\jz{Start CMC-related criticism}
...
\jz{I think shifting the focus from "the CMC method is [xyz]" to "forensic algorithms in-general tend to be [xyz], and the CMC method is no exception" would soften the tone slightly.}
...
However, using the CMC pipelines as an example we have observed that conceptual descriptions only enable a qualitative reproduction of results.
