...
kmComparison_combinedCMCs <- decision_combineCMCDirections(kmComparison_cmcs,
...
## Why is it cropExterior and filterInterior?
## It looks like both functions have the same parameterization
## how about a preprocess_crop with a parameter area that is "interior" or "exterior"?
...
knmComparison_combinedCMCs <- decision_combineCMCDirections(knmComparison_cmcs,
                                                            knmComparison_cmcs_rev)
```
