...
cmcPlots$initialCMC
```
```{r,echo=FALSE,cache = F,fig.cap='\\label{fig:topVoteCMCPlot} CMC results from a known match comparison under the \\citet{song_proposed_2013} asymmetric method using the \\code{cmcPlot} function',fig.align='center',fig.pos='htbp',out.width='1.2\\textwidth',out.extra="trim={0 2.5cm 0 2cm}"}
...
cmcPlots <- cmcR::cmcPlot(fadul1.1$x3p,
                          ...
                          height.colors = colorspace::darken(c('#7f3b08','#b35806','#e08214','#fdb863','#fee0b6','#f7f7f7','#d8daeb','#b2abd2','#8073ac','#542788','#2d004b'),amount = .2),
