...
\svp{The matching procedure is performed twice: once with scan A partitioned and scan B as the target, and once with scan B partitioned and scan A as the target.} \jz{For both of these comparisons, only cells with a minimum proportion of non-missing pixels are considered. The minimum threshold differs across CMC papers} \jz{XXX \citet{tong_fired_2014}, \citet{song_3d_2014}, and \citet{chu_validation_2013} say that they do it yet don't specify a threshold, \cite{tong_improved_2015} don't describe preprocessing at all, \citet{chen_convergence_2017} use a cutoff of 15%, \citet{song_estimating_2018} use 10% XXX}
