...
\svp{xxx This probably should be a pipeline, not a single function call. But that's just my opinion. Also, this still has ransac parameters, which we might want to get rid of as we're no longer explaining them XXX}
