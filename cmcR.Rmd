...
fadul1.1_croppedExt <- cmcR::preProcess_cropExterior(x3p = fadul1.1_original,
                                            radiusOffset = -30,
                                            agg_function = median) 

fadul1.1_croppedInt <- cmcR::preProcess_filterInterior(fadul1.1_croppedExt,
                                                         radiusOffset = 200)
...
fadul1.1_cropped <- fadul1.1 %>%
  preProcess_cropExterior(radiusOffset = -30) %>%  
  preProcess_filterInterior(radiusOffset = 200)
```
...
The \code{preProcess\_cropExterior} and \code{preProcess\_filterInterior} functions remove the exterior and firing pin impression region on the interior, respectively.}
