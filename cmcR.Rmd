...
The user-specified \code{radiusOffset} value is added to the radius estimate.
...
The \code{preProcess\_crop} function is used to remove the exterior and firing pin impression region on the interior based on the \code{region} argument.}
