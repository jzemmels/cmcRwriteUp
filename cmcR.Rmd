...
```{r echo = FALSE,cache = T,fig.align = 'left',fig.cap="\\label{fig:translationVotes} Estimated translation values within 15 pixels of median value for 1 Known Match and 1 Known Non-Match cartridge case pair. \\svp{XXX Joe, you need to describe exactly what it is we're supposed to see in this picture, because right now I'm not really seeing it. If it's that we have more dispersed estimates for translations in the 2nd figure, then ... maybe choose a better example?}",fig.pos = 'h'}
