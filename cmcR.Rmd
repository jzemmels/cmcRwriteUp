...
\caption{\hh{Overview of the set of pre-processing steps used in the CMC algorithms.} Where a procedure step is not discussed or explicitly not applied in the paper, the path traverses empty space.}\label{fig:preprocessing-schematic}
\end{figure}
