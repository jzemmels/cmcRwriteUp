...
\jz{Starting to get into CMC-specific criticism here XXX I've attempted to add a more "aspirational" tone to this paragraph and address some of R1's comments, but it might feel a bit too much like a discussion/conclusion paragraph.}
...
<!-- \jz{This whole section could be considered CMC-related criticism. Once we figure out the introduction, then the tone of this section could be tuned to match.} -->
...
\jz{We bring up these ambiguities not to nitpick or poke holes in the original algorithms, but to highlight how a conceptual description does not contain sufficient information to computationally reproduce an algorithm.
