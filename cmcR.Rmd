...
knmCMCPlot_list <- cmcR::cmcPlot(fadul1.1,
              fadul2.1,
              cellCCF_bothDirections_output = knmComparison,
              cmcFilter_improved_output = knmCMC,
              type = "list",
...
kmCMCPlot_list <- cmcR::cmcPlot(fadul1.1,
                          fadul1.2,
                          # fadul1.2$x3p,
                          # fadul1.1$x3p,
                          cellCCF_bothDirections_output = kmComparison,
...
# kmCMCPlot_list$originalMethodCMCs$`Fadul 1-1` <- kmCMCPlot_list$originalMethodCMCs$`Fadul 1-1` +
#   ggplot2::theme(legend.position = "none")
# 
# knmCMCPlot_list$originalMethodCMCs$`Fadul 2-1` <- knmCMCPlot_list$originalMethodCMCs$`Fadul 2-1` +
#   ggplot2::theme(legend.position = "none")

# kmCMCPlot_list$originalMethodCMCs$`Fadul 1-2` <- kmCMCPlot_list$originalMethodCMCs$`Fadul 1-2` +
#   ggplot2::theme(legend.position = "none")

# ggplot2::ggsave(filename = "derivatives/fadul1-1_cmc.png",
#                 plot = kmCMCPlot_list$originalMethodCMCs$`Fadul 1-1`)
# 
# ggplot2::ggsave(filename = "derivatives/fadul1-2_cmc.png",
#                 plot = kmCMCPlot_list$originalMethodCMCs$`Fadul 1-2`)
# 
# ggplot2::ggsave(filename = "derivatives/fadul2-1_cmc.png",
#                 plot = knmCMCPlot_list$originalMethodCMCs$`Fadul 2-1`)

knitr::include_graphics("images/originalMethod_sideBySide.PNG")
```
