...
The Congruent Matching Cells (CMC) pipeline is a collection of algorithms developed by a group of researchers at the National Institute of Standards and Technology (NIST) to process and compare cartridge case evidence \citep{song_proposed_2013}.
...
As discussed in the introduction, it is difficult to replicate manual steps as part of a reproducible pipeline; the best solution is for the authors to provide intermediate data after the manual steps have been completed.
...
Through the development of the cmcR package, we have demonstrated the ambiguities in the [CMC pipeline descriptions](cmcMethod) and lack of guidance in the choice of parameter settings propagate through the algorithm and produce highly variable results.
...
All processed data used in this paper are available on Github ([https://github.com/CSAFE-ISU/cartridgeCaseScans](https://github.com/CSAFE-ISU/cartridgeCaseScans)).
