...
originalMethod_comparison1to2_pcp <- congruentData_comparison1to2 %>%
  ...
  pivot_longer(cols = c(dx,dy,theta,ccf),
               names_to = "parameter") %>%
  # mutate(Classification = case_when(parameter == "dx" & value >= extremaData_comparison1to2[1,"ymin"][[1]] & value <= extremaData_comparison1to2[1,"ymax"][[1]] ~ "Congruent",
  #                                   parameter == "dy" & value >= extremaData_comparison1to2[2,"ymin"][[1]] & value <= extremaData_comparison1to2[2,"ymax"][[1]] ~ "Congruent",
  #                                   parameter == "theta" & value >= extremaData_comparison1to2[3,"ymin"][[1]] & value <= extremaData_comparison1to2[3,"ymax"][[1]] ~ "Congruent",
  #                                   parameter == "ccf" & value >= extremaData_comparison1to2[4,"ymin"][[1]] & value <= extremaData_comparison1to2[4,"ymax"][[1]] ~ "Congruent",
  #                                   TRUE ~ "Not Congruent")) %>%
  mutate(parameter = factor(parameter,c("dx","dy","theta","ccf")),
         Classification = factor(Classification,levels = c("Congruent","Not Congruent"))) %>%
  ggplot() +
  # geom_point(aes(x = parameter,y = value,colour = Classification)) +
...
originalMethod_comparison2to1_pcp <- congruentData_comparison2to1 %>%
  ...
  pivot_longer(cols = c(dx,dy,theta,ccf),
               names_to = "parameter") %>%
  # mutate(Classification = case_when(parameter == "dx" & value >= extremaData_comparison2to1[1,"ymin"][[1]] & value <= extremaData_comparison2to1[1,"ymax"][[1]] ~ "Congruent",
  #                                   parameter == "dy" & value >= extremaData_comparison2to1[2,"ymin"][[1]] & value <= extremaData_comparison2to1[2,"ymax"][[1]] ~ "Congruent",
  #                                   parameter == "theta" & value >= extremaData_comparison2to1[3,"ymin"][[1]] & value <= extremaData_comparison2to1[3,"ymax"][[1]] ~ "Congruent",
  #                                   parameter == "ccf" & value >= extremaData_comparison2to1[4,"ymin"][[1]] & value <= extremaData_comparison2to1[4,"ymax"][[1]] ~ "Congruent",
  #                                   TRUE ~ "Not Congruent")) %>%
  mutate(parameter = factor(parameter,c("dx","dy","theta","ccf")),
         Classification = factor(Classification,levels = c("Congruent","Not Congruent"))) %>%
  ggplot() +
