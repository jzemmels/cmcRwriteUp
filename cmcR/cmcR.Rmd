...
The CMCs determined under the High CMC method (i.e., the "high" CMCs) are show below. We can see that 40 out of the 
```{r echo=TRUE,eval=FALSE}
cmcPlots$highCMC
```
