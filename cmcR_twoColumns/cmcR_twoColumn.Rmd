...
The \textbf{x3ptools} package \citep{x3ptools} can be used to work with these x3p files in R.\footnote{\autoref{fig:cartridgeCasePair} shows two unprocessed, known match cartridge case scans.}
...
\subsubsection{Implementation of preprocessing procedures}{sec:preProcessImplement}
