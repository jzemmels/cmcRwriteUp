...
arise when only computationally ambiguous descriptions of algorithms are
provided.
}
...
{\centering \subfloat[\label{fig:rawBFs-1}]{\includegraphics[width=.49\linewidth,height=.49\linewidth]{derivatives/fadul1-1} }\subfloat[\label{fig:rawBFs-2}]{\includegraphics[width=.49\linewidth,height=.49\linewidth]{derivatives/fadul1-2} }
...
{\centering \includegraphics[width=\textwidth]{zemmels-vanderplas-hofmann_files/figure-latex/unnamed-chunk-5-1} 
...
{\centering \includegraphics[width=\textwidth]{zemmels-vanderplas-hofmann_files/figure-latex/unnamed-chunk-10-1} 
...
{\centering \includegraphics[width=\textwidth]{derivatives/kmOriginalMethod} 
...
{\centering \includegraphics[width=\textwidth]{derivatives/kmHighCMC} 
...
{\centering \includegraphics[width=\textwidth]{derivatives/knmOriginalMethod} 
