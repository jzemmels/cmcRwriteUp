...
We would like to thank the creators/maintainers of a number of R
packages upon which the general infrastructure of \CRANpkg{cmcR} relies.
First and foremost, we would like to thank Hadley Wickham and the
RStudio team for developing the \CRANpkg{tidyverse} suite of packages
without which it would have been difficult to structure \CRANpkg{cmcR}
in an intuitive, modularized format \citep{tidyverse}. Additionally,
\CRANpkg{knitr}, \CRANpkg{rmarkdown}, and \CRANpkg{rticles} have been
incredibly useful for communicating and ensuring reproducibility of our
work \citep{knitr,rmarkdown,rticles}.
...
#>  [1] patchwork_1.1.1 rgl_0.105.13    x3ptools_0.0.3  forcats_0.5.1  
...
#> [10] DBI_1.1.1               colorspace_2.0-0        manipulateWidget_0.10.1
#> [13] withr_2.4.1             readbitmap_0.1.5        tidyselect_1.1.0       
#> [16] compiler_4.0.3          cli_2.3.1               rvest_0.3.6            
#> [19] quantreg_5.83           SparseM_1.78            xml2_1.3.2             
#> [22] labeling_0.4.2          scales_1.1.1            digest_0.6.27          
#> [25] tiff_0.1-7              rmarkdown_2.6           rticles_0.18           
#> [28] jpeg_0.1-8.1            pkgconfig_2.0.3         htmltools_0.5.1.1      
#> [31] dbplyr_2.1.0            fastmap_1.1.0           htmlwidgets_1.5.3      
#> [34] rlang_0.4.10            readxl_1.3.1            rstudioapi_0.13        
#> [37] shiny_1.6.0             generics_0.1.0          farver_2.0.3           
#> [40] zoo_1.8-8               jsonlite_1.7.2          crosstalk_1.1.1        
...
#> [52] grid_4.0.3              promises_1.2.0.1        crayon_1.4.1           
#> [55] miniUI_0.1.1.1          lattice_0.20-41         cowplot_1.1.1          
#> [58] haven_2.3.1             hms_1.0.0               knitr_1.31             
#> [61] pillar_1.5.1            igraph_1.2.6            imager_0.42.3          
#> [64] reprex_1.0.0            glue_1.4.2              evaluate_0.14          
#> [67] bmp_0.3                 modelr_0.1.8            png_0.1-7              
#> [70] vctrs_0.3.6             httpuv_1.5.5            MatrixModels_0.4-1     
#> [73] cellranger_1.1.0        gtable_0.3.0            assertthat_0.2.1       
#> [76] xfun_0.21               mime_0.10               xtable_1.8-4           
#> [79] broom_0.7.4             later_1.1.0.1           conquer_1.0.2          
#> [82] ellipsis_0.3.1
\end{Soutput}
\end{Schunk}
