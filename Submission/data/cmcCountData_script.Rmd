---
title: "Calculation of cmcCountData"
output: html_notebook
---

This notebook is used to perform a CMC comparison for the 63 matching and 717 non-matching pairs in the Fadul cartridge case data set. The final result is a cmcCountData data frame containing CMC results for a set of processing conditions (i.e., choice of thresholds and whether a scan is de-trended during preprocessing) including the associated variance ratio values and AUCs.

The notebook assumes that the Fadul .x3p files are stored locally in a folder called data/, but can be adapted to download straight from the NIST Ballistics Toolmark Research Database:

https://tsapps.nist.gov/NRBTD/Studies/Studies/Details/e7a8aab8-8d5a-44ac-b2be-f0de7c2ca505?nm=True&mt=1&m=3&sp=1
